...
def get_model(args):
    if args.dataset_name == "MNIST":
        return SimpleUNet(T=args.T)
    else:
        return UNet(c_in=args.image_channels, c_out=args.image_channels, time_dim=args.time_emb_dim, device=args.device)